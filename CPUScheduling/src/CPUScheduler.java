...
public class CPUScheduler extends Thread {
    ...
    public void run() {    
        ...
        JOptionPane.showMessageDialog(null, "Process Completed\nCheck out the finished files in the OS Scheduler Finished Files folder\nLocation: Desktop/OS Scheduler Finished Files");

        // JOptionPane.showMessageDialog(null, "Process Completed\n" + "Check it out on OS Scheduler Finished File folder\n" + "Location: Desktop");
    }
